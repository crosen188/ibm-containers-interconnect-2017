...
Prior to running this lab, you must have a Bluemix account and access to a lab laptop (containers / containers).  Instructions are available in the prerequisites section to create your Bluemix account, log into the Bluemix UI, and create a unique namespace.
